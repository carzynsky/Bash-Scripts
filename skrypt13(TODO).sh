...
# utworzyć plik regularny W, którego zawartość będzie 
# połączoną zawartością plików regularnych z listy 
# z pliku P. Kolejność w jakiej pliki zostaną 
# połączone powinna być zgodna z kolejnością na 
# liście P. Treść każdego pliku powinna być 
